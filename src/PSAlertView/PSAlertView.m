...
- (void)addEmailButtonWithText:(NSString *)text {
    ...
    [self.emailButton setTitleColor:PSALERTVIEW_RGBCOLOR(230, 230, 230) forState:UIControlStateNormal];
...
- (void)relayoutViews {
    ...
    CGFloat superHeight = [UIScreen mainScreen].bounds.size.height - [[UIApplication sharedApplication] statusBarFrame].size.height;
